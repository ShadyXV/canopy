        ...
        {placedAssets.length === 0 ? (
          ...
          <ul className="p-1.5 space-y-0.5">
            {placedAssets.map((asset, i) => {
              ...
              const shaderVariant = getShaderVariant(asset.shader)
              return (
                <li
                  key={asset.id}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className={`inline-block text-[9px] px-1.5 py-0.5 rounded border font-mono ${shaderVariant.outlinerClass}`}>
                      {shaderVariant.label}
                    </span>
                  </div>
